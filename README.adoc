...
. Visit
  ...
  Linux] and follow the instruction to install the offical Clojure CLI tools for Linux.
+
...
. Visit
  ...
  on Mac via brew] and follow the instruction to install the offical Clojure CLI tools for
  Mac OSX.
+
The instruction is reproduced here for your convenience.
+
